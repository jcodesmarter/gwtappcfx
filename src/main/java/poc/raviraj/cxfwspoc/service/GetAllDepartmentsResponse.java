 ...
 *       &lt;sequence&gt;
 *         &lt;element name="return" type="{http://service.cxfwspoc.raviraj.poc/}department" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class GetAllDepartmentsResponse {
    ...
    protected List<Department> _return;
     ...
     * 
     */
    public List<Department> getReturn() {
        if (_return == null) {
            _return = new ArrayList<Department>();
        }
        return this._return;
    }
